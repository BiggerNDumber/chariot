chariot.ui.curr_opt = "opt_main"
chariot.ui.prev_opt = nil

chariot.ui.opts.func = function(e)
  G.SETTINGS.paused = true
  G.FUNCS.overlay_menu({
    definition = chariot.ui.opts.box(),
    config = {
      offset = {
        x = 0,
        y = 0,
...
G.FUNCS.chariot_config = function(e)
  chariot.ui.opts.func(e)
end
